...
include('connection.php');
    ...
    // {
        ...
        //     //SMTP username
        //     $mail->Username = 'narutemayuri28@gmail.com';
 
        //     //SMTP password
        //     $mail->Password = 'cwitoxvdewxytgvy';
        ...
        //     //Recipients
        //     $mail->setFrom('narutemayuri28@gmail.com', '');
        ...
        //     $mail->Subject = 'Rock Hammer Fitness Club - Email verification';
        //     $mail->Body    = '<p>Your verification code is: <b style="font-size: 25px;">' . $verification_code . '</b></p>';
        ...
        //     $encrypted_password = password_hash($password, PASSWORD_DEFAULT);
            ...
            // $sql = "INSERT INTO users(Name, Age, Email,Password, Phone) VALUES ('" . $name . "', '" . $age . "', '" . $email . "', '" . $password . "', '" . $phone . "')";
            // mysqli_query($db, $sql);
